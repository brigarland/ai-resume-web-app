...
import { stories, resumeData } from '../src/data/stories';
import type { JobAnalysisRequest, JobAnalysisResponse } from '../src/types';
...
export default async function handler(
  ...
  try {
    const { jobUrl } = req.body as JobAnalysisRequest;
